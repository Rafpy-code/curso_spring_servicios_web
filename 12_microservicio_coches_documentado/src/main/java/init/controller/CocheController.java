...
public class CocheController {
	...
	@Operation(summary = "Búsqueda por marca.")
	@GetMapping(value = "buscarMarca/{marca}", produces = MediaType.APPLICATION_JSON_VALUE)
	public List<Coche> buscarPorMarca(@Parameter(description = "Ingresar la marca del coche a buscar") @PathVariable("marca") String marca) {
	...
	@Operation(summary = "Alta de nuevos coches", description = "Recibe como parámetros un Json, si la matrícua existe no se agrega.")
	@PostMapping(value = "alta", consumes = MediaType.APPLICATION_JSON_VALUE)
	public void alta(@Parameter(description = "Objeto Json con todos los datps del coche.") @RequestBody Coche coche) {
		service.save(coche);
	}
